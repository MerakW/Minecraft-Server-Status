...
$host = "mc.merakt.cn"; //设置服务器域名或 IP
$port = "25565"; //设置服务器端口，可以直接用服务器的链接端口，也可以使用query端口（UDP协议）
$name = 'Eco Craft 2nd 🍀'; // 服务器名字，会显示在标签页的标题和网站打头的大标题处
$iconlink = 'https://z3.ax1x.com/2021/07/29/WqDQxK.png'; // 网站图标链接，可以使图片格式（.png/.jpg/etc.）或者是ico图标，用绝对路径或相对路径均可
...
$imagelink = 'https://z3.ax1x.com/2021/07/29/WqDQxK.png'; // 图片链接，会显示在服务器信息右边的圈圈里
/*
$host = $_GET["host"];
$port = $_GET["port"];
